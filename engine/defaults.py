...
def default_argument_parser():
    ...
    parser.add_argument("--eval", default=True, dest='eval_only', action="store_true", help="perform evaluation only")
    ...
    parser.add_argument(
        ...
        default="pretrained_model/monoflex/model_moderate_best_soft.pth",
    )
